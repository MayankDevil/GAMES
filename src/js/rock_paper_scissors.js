...
- File : ./js/rock_paper_scissors.js
*/
            ...
            return (`
                <section id="outCome">
                    ...
                    <div id="first">
                        ...
                        <img src="../src/img/${player_choice}.png" alt="${player_choice}" class="img">
                    ...
                    <div id="last">
                        ...
                        <img src="../src/img/${system_choice}.png" alt="${system_choice}" class="img">
